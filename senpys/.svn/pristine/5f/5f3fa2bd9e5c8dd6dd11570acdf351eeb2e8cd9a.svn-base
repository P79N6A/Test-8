...
public class CustomMailImplService extends Service {
    ...
    public com.tydic.sendEdm.CustomMailInterface getCustomMailImplPort() {
        return super.getPort(CustomMailImplPort, com.tydic.sendEdm.CustomMailInterface.class);
    }
     ...
     */
    @WebEndpoint(name = "CustomMailImplPort")
    public com.tydic.sendEdm.CustomMailInterface getCustomMailImplPort(WebServiceFeature... features) {
        return super.getPort(CustomMailImplPort, com.tydic.sendEdm.CustomMailInterface.class, features);
    }
