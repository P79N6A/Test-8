...
public class InfoUserExternalAccountAttr implements Serializable{
	...
	public InfoUserExternalAccountAttr(){}
	
	public InfoUserExternalAccountAttr(InfoUserExternalAccount infoUser){
		this.external_account_id=infoUser.getExternal_account_id();
		this.user_id=infoUser.getUser_id();
		this.jd_pin=infoUser.getJd_pin();
		this.external_system_code=infoUser.getExternal_system_code();
