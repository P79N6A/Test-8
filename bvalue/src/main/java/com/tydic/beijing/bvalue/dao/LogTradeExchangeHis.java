 ...
 * 
 */
public class LogTradeExchangeHis implements Serializable {
	...
	public String toString() {
		return "LogTradeExchangeHis [trade_id=" + trade_id + ", trade_type_code=" + trade_type_code
				+ ", user_id=" + user_id + ", partition_id=" + partition_id
				+ ", resource_type_code=" + resource_type_code + ", resource_value="
				+ resource_value + ", eff_date=" + eff_date + ", exp_date=" + exp_date
				+ ", exchange_time=" + exchange_time + ", reserve_1=" + reserve_1 + ", reserve_2="
				+ reserve_2 + ", reserve_3=" + reserve_3 + ", reserve_4=" + reserve_4 + "]";
	}
