...
public class InfoAuthMobile implements Serializable {
	...
	public String toString() {
		return "InfoAuthMobile [auth_id=" + auth_id + ",customer_id="
				+ customer_id + ",user_id=" + user_id + ",device_number="
				+ device_number + ",auth_date=" + auth_date + ",exp_date="
				+ exp_date + ",eff_flag=" + eff_flag + ",customer_name="
				+ customer_name + ",real_id_type=" + real_id_type
				+ ",real_id_number=" + real_id_number + ",real_id_exp_date="
				+ real_id_exp_date + ",real_id_address=" + real_id_address
