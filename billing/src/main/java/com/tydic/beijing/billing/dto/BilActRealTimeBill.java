...
/**
 * BilActUserRealTimeBill对应数据库中BIL_ACT_USER_REAL_TIME_BILL_XX(用户实时账单表)
 * 
 * @author yuandao
 * 
 */
public final class BilActRealTimeBill implements Serializable {
	private static final long serialVersionUID = 1L;
	private String user_id;
	private int acct_month;
	private int acct_item_code;
	private String acct_item;
	...
	public String getAcct_item() {
		return acct_item;
	}

	public void setAcct_item(String acct_item) {
		this.acct_item = acct_item;
	}
