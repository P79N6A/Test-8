...
public class ChargeTermReq {
    ...
    private List<UsedAcctItem> m_iUsedAcctItems =new ArrayList<UsedAcctItem>();
    private List <RequestRatableUpdate> m_iRequestRatableUpdates = new ArrayList<RequestRatableUpdate>();
    private  int m_unAoCConfirmation;
	...
	public int getM_unAoCConfirmation() {
		return m_unAoCConfirmation;
	}
	public void setM_unAoCConfirmation(int m_unAoCConfirmation) {
		this.m_unAoCConfirmation = m_unAoCConfirmation;
	}
