...
public class QCreditInfoUserCreditlog implements Serializable  {
		...
		public String toString() {
			return "QCreditInfoUserCreditlog [serial_num=" + serial_num + ", action=" + action + ", enqueue_date="
					+ enqueue_date + ", local_net=" + local_net + ", user_id=" + user_id + ", credit_type="
					+ credit_type + ", credit_number=" + credit_number + ", eff_date=" + eff_date + ", exp_date="
					+ exp_date + ", eff_flag=" + eff_flag + ", process_time=" + process_time + "]";
		}
