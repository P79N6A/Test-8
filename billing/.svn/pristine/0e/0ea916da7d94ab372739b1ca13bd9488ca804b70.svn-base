...
/**
 * LifeUserPay 对应数据库中LIFE_USER_PAY（支付关系表）
 * 
 * @author Tian
 *
 */
public final class LifeUserPay implements Serializable {
	...
	public String toString() {
		return "UserPayId[" + user_pay_id + "]UserId[" + user_id + "]PayId["
				...
				+ eff_date + "]ExpDate[" + exp_date + "]LimitType["
				+ limit_type + "]LimitVa[" + limit_valuea + "]LimitVb["
				+ limit_valueb + "]";
	}
}
