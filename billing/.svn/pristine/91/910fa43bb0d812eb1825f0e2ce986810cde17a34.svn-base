...
public class TbSmsSendHis implements Serializable{
	...
	public String toString() {
		return "TbSmsSendHis [msg_id=" + msg_id + ", msisdn_send="
				+ msisdn_send + ", msisdn_receive=" + msisdn_receive
				+ ", message_text=" + message_text + ", send_time=" + send_time
				+ ", process_tag=" + process_tag + ", para_key=" + para_key
				+ ", deal_flag=" + deal_flag + ", complete_time="
				+ complete_time + ", job_number=" + job_number + ", msg_prior="
				+ msg_prior + "]";
	}
