...
public class QUserReasonSendPre {
	...
	public String toString() {
		return "QUserReasonSendPre [serial_num=" + serial_num + ", user_no=" + user_no
				+ ", tele_type=" + tele_type + ", reason_code=" + reason_code + ", enqueue_date="
				+ enqueue_date + ", local_net=" + local_net + ", active_type=" + active_type
				+ ", charge_id=" + charge_id + "]";
	}
