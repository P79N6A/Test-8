...
public class BilActResourceAddUp implements Serializable {
	...
	public String toString() {
		return "BilActResourceAddUp [user_id=" + user_id + ", acct_month=" + acct_month
				+ ", partition_num=" + partition_num + ", resource_id=" + resource_id
				+ ", resource_value=" + resource_value + ", update_time=" + update_time
				+ ", insert_timestamp=" + insert_timestamp + "]";
	}

	public String getMain_ofr_id() {
		return main_ofr_id;
	}

	public void setMain_ofr_id(String main_ofr_id) {
		this.main_ofr_id = main_ofr_id;
	}
