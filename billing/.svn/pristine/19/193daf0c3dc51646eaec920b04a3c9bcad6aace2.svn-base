...
public class QPresentUserInfo implements Serializable {
	...
	public String toString() {
		return "QPresentUserInfo [user_id=" + user_id + ", protocol_id="
				+ protocol_id + ", resource_type=" + resource_type
				+ ", resource_value=" + resource_value + ", eff_date="
				+ eff_date + ", exp_date=" + exp_date + ", create_time="
				+ create_time + ", deal_time=" + deal_time + ", state=" + state
				+ ", present_user_id=" + present_user_id + ", serv_code="
				+ serv_code + ", operate_type=" + operate_type
				+ "]";
	}
}
