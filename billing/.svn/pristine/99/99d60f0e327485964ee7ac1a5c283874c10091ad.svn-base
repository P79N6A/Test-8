...
public class InstContractServiceImpl {
	private static org.slf4j.Logger log = LoggerFactory.getLogger(InstContractServiceImpl.class);
	
	private ContractDb db;
	
	private InstContractServiceImplProcess instContractServiceImplProcess;

	public InstContractServiceImplProcess getInstContractServiceImplProcess() {
		return instContractServiceImplProcess;
	}

	public void setInstContractServiceImplProcess(
			InstContractServiceImplProcess instContractServiceImplProcess) {
		this.instContractServiceImplProcess = instContractServiceImplProcess;
	}
	...
	*/
	...
	public static String[] ComputePresentRule(RuleResourceRelease rule_resource_release){
		...
		case "1":{//--平均
			...
			for(i=1; i<(rule_resource_release.getRelease_cycle()-1); i++){
	...
	public List<QPresentUserInfo> Inst(List<QPresentUserInfo> ListPresentUser) throws Exception {
		...
		try{
			...
			for(QPresentUserInfo present_user_id:ListPresentUserId){
				this.instContractServiceImplProcess.Inst(present_user_id);
			}
//			for(QPresentUserInfo present_user_id:ListPresentUserId){
...
//					if(q_present_user_info.getServ_code().equals("027") || q_present_user_info.getServ_code().equals("019") || q_present_user_info.getServ_code().equals("016")){
