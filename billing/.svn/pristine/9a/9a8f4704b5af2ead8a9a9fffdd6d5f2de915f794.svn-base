...
public final class InfoUser implements Serializable {
	...
	private String product_id; //ofr_id
	...
	public String toString() {
		return "InfoUser [user_id=" + user_id + ", tele_type=" + tele_type
				+ ", device_number=" + device_number + ", user_pwd=" + user_pwd
				+ ", user_status=" + user_status + ", create_date="
				+ create_date + ", active_date=" + active_date + ", user_type="
				+ user_type + ", prepay_flag=" + prepay_flag + ", local_net="
				+ local_net + ", develop_channel_id=" + develop_channel_id
				+ ", product_id=" + product_id + ", proto_flag=" + proto_flag
				+ ", sub_user_status=" + sub_user_status + ", stop_date="
				+ stop_date + ", valid_flag=" + valid_flag + "]";
	}
